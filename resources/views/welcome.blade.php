    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="sm:fixed sm:top-0 sm:left-0 p-6 text-left z-10">
                {{-- ইউজারদের subscriber-only” authenticated আছে কিনা তা চেক করি without autentic redirect login page or home page--}}
                ...
                {{--  @can directive ব্যবহার করে ইউজারদের subscriber-only” authenticated আছে কিনা তা চেক করি। authenticated ইউজার subscriber-only অনুমতি না থাকলে আমাদের লিঙ্কটি প্রদর্শিত হবে না --}}
